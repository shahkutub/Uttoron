 ...
 */
class SaveBitmapTask(val mContext: Context, private val bitmap: Bitmap, private val name: String,private val outputDir: String, private val downloadListener: DownloadListener) : AsyncTask<String?, Int?, Boolean>() {
